        ...
        <div className="tw:grid tw:gap-4 tw:sm:grid-cols-2">
          <label className="tw:flex tw:flex-col tw:gap-1">
            ...
            {serversLoaded && !busy.servers && servers.length === 0 && (
              <span className="tw:text-muted-foreground">{__('No servers found for this token.', 'fastcgi-cache-for-ploi')}</span>
            )}
          </label>
          ...
          <label className="tw:flex tw:flex-col tw:gap-1">
            ...
            {!target.serverId && <span className="tw:text-muted-foreground">{__('Choose a server first.', 'fastcgi-cache-for-ploi')}</span>}
          </label>
        </div>
