...
<div class="tw:flex tw:flex-col tw:gap-4">
    <div class="tw:grid tw:gap-4 tw:sm:grid-cols-2">
        <label class="tw:flex tw:flex-col tw:gap-1">
            ...
            <span class="tw:text-[13px] tw:text-gray-500" x-show="!busy.servers && servers.length === 0"><?php echo esc_html__('No servers found for this token.', 'fastcgi-cache-for-ploi'); ?></span>
        </label>
